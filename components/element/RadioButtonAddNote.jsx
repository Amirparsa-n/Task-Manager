const RadioButtonAddNote = ({ color, noteDate, setNoteData }) => {
    return (
        <div
            className={`p-5 w-1/5 last:rounded-e-lg first:rounded-s-lg flex justify-center items-center ${color === "yellow" && "bg-yellowNote"} ${
            ...
            <input
                ...
                style={{ display: "none" }}
            />
            <label htmlFor={color} className="check w-1/5 before:absolute before:-left-5 before:-top-5 before:w-16 sm:before:w-32 sm:before:-left-[52px]">
