    ...
    return (
        <>
            <div
                ...
                id="main-image">
                <div
                    className={`md:m-auto w-[604px] md:max-w-2xl h-[calc(100vh-124px)] md:rounded-xl border-t-2 border-primary md:border-none transitionSidebar bg-white dark:bg-DarkSecond md:h-fit md:pt-6 px-4 md:px-8 py-6 slideInUp fadeIn `}>
